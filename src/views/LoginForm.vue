...
<!--    <div class="card p-4 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-white ">-->
      <Form @submit="handleLogin" :validation-schema="schema" class="space-y-6 w-[350px]" action="#">
...
<!--          <input type="email" name="email" id="email" class="bg-blue-300 border border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-blue-300 dark:border-blue-500 dark:placeholder-gray-300 dark:text-white" placeholder="name@company.com" required>-->
          <Field type="email" name="username" id="email" class="bg-blue-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:bg-blue-300 dark:border-blue-500 dark:placeholder-gray-600 dark:text-white font-sans"  placeholder="name@company.com"/>
          <ErrorMessage name="username" class="error-feedback" />
        </div>
        <div class="form-group">
          <label for="password" class="block mb-2 text-md font-medium text-gray-900 dark:text-sky-900">Password</label>
          <Field type="password" name="password" id="password" placeholder="********" class="bg-blue-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-blue-500 dark:border-blue-500 dark:placeholder-gray-600 dark:text-white"/>
